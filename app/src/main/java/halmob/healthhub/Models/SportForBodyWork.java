...
public class SportForBodyWork {
    ...
    public String getNumberOfRepetitionForBodyWork() { return NumberOfRepetitionForBodyWork;}
    public void setNumberOfRepetitionForBodyWork(String NumberOfRepetitionForBodyWork) { this.NumberOfRepetitionForBodyWork = NumberOfRepetitionForBodyWork; }

    public String getNumberOfSetForBodyWork() { return NumberOfSetForBodyWork;}
    public void setNumberOfSetForBodyWork(String NumberOfSetForBodyWork) { this.NumberOfSetForBodyWork = NumberOfSetForBodyWork; }

    public String getWeightForBodyWork() { return WeightForBodyWork;}
